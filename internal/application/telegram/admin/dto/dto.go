...
type AdminTelegramBindingResponse struct {
	...
	WeeklySummaryHour           int       `json:"weekly_summary_hour"`
	WeeklySummaryWeekday        int       `json:"weekly_summary_weekday"`
	OfflineCheckIntervalMinutes int       `json:"offline_check_interval_minutes"`
