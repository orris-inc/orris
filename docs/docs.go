...
const docTemplate = `{
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_interfaces_http_handlers.UpdateSubscriptionStatusRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "internal_interfaces_http_handlers.UpdateSubscriptionStatusRequest": {
            "type": "object",
            "required": [
                "status"
            ],
            "properties": {
                "immediate": {
                    "description": "Optional for cancellation",
                    "type": "boolean"
                },
                "reason": {
