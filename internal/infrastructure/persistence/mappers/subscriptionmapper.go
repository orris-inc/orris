...
func (m *SubscriptionMapperImpl) ToEntity(model *models.SubscriptionModel) (*subscription.Subscription, error) {
	...
	entity, err := subscription.ReconstructSubscriptionWithParams(subscription.SubscriptionReconstructParams{
		...
		TrafficLimitOverride:  model.TrafficLimitOverride,
		TrafficUsedAdjustment: model.TrafficUsedAdjustment,
		Metadata:              metadata,
...
func (m *SubscriptionMapperImpl) ToModel(entity *subscription.Subscription) (*models.SubscriptionModel, error) {
	...
	model := &models.SubscriptionModel{
		...
		TrafficLimitOverride:  entity.TrafficLimitOverride(),
		TrafficUsedAdjustment: entity.TrafficUsedAdjustment(),
